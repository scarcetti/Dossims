                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            ...
                                            <a href="{{ ENV('APP_URL') }}/admin/transactions/{{ $data->id }}/edit" title="View" class="btn btn-sm btn-warning pull-right view">
                                                <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">View</span>
                                            </a> 
                                            @if($data->status == 'procuring')
                                                <a href="{{ ENV('APP_URL') }}/admin/transactions/cutting-list/{{ $data->id }}" title="View" class="btn btn-sm btn-primary pull-right view">
