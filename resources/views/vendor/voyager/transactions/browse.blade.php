                                            ...
                                            <div class="">
                                                ...
                                                <label class="switch">
                                                    @if (isset(Request::all()['hide_unpaid']))
                                                        <input name="hide_unpaid" type="checkbox" checked
                                                            onclick="submit()">
                                                    @else
                                ...
                                <tbody>
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                            ...
                                            @endforeach
                                            @php
                                                $item_count = \App\Models\TransactionItem::where('transaction_id', $data->id)
                                                    ->get()
                                                    ->count();
                                            @endphp
                                            ...
                                            @endif --}}
                                                ...
                                                @endif --}}
                                                    @if ($data->status == 'waiting for payment')
                                                        <a href="{{ ENV('APP_URL') }}/admin/transactions/{{ $data->id }}/edit"
                                                            title="View" class="btn btn-sm btn-success pull-right view">
                                                            <i class="voyager-eye"></i> <span
                                                                class="hidden-xs hidden-sm">Add Payment</span>
                                                        </a>
                                                    @else
                                                        <a href="{{ ENV('APP_URL') }}/admin/transactions/{{ $data->id }}/edit"
                                                            title="View" class="btn outlinedBtn pull-right view">
                                                            <i class="voyager-eye"></i> <span
                                                                class="hidden-xs hidden-sm">View</span>
                                                        </a>
                                                    @endif
                                                    @if ($data->status == 'procuring')
                                                        <a href="{{ ENV('APP_URL') }}/admin/cutting-list/{{ $data->id }}"
                                                            title="View" class="btn btn-sm btn-warning pull-right view"
                                                            style="margin-right: 6px;">
                                                            <i class="voyager-eye"></i> <span
                                                                class="hidden-xs hidden-sm">Cutting list</span>
                                                        </a>
                                                    @elseif(in_array($data->status, ['preparing for delivery', 'waiting for pickup']))
                                                        <button class="btn btn-info btn-lg"
                                                            onclick="completeTx({{ $data->id }})">Complete
                                                            transaction</button>
                                                    @endif
                                                @endif
                                            </td>
