...
class VoyagerBaseController extends BaseVoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if(in_array($request->get('key'), ['created_at', 'updated_at']) && !$this->valiDate_($request->get('s'))) {
            $search = (object) ['value' => '', 'key' => $request->get('key'), 'filter' => $request->get('filter')];
        }
        else {
        ...
        function valiDate_($date) # return false if error
        {
